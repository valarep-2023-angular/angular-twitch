          ...
          <div class="bg-gray-900">
              ...
              <app-main-header>
                  <app-main-nav>
                      ...
                      <app-main-nav-item text="Musique" [isCurrent]="true" link="#" />
              ...
              <div class="px-6">
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Streams musicaux pour vous</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Artistes suggérés</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Productions musicales et discussions</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Soutien des petits streamers de musique</h3>
                  ...
                  <!-- TODO: PROCHAINS STREAMS MUSICAUX -->

                  <h3 class="text-white text-xl font-medium py-4">Acoustique et Instrumental</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Hip-hop et Rap</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Rock et Métalx</h3>
...
export const Music = exampleTemplate.bind({});
Music.args = { title: 'Angular Twitch Clone' };

          ...
          <div class="bg-gray-900">
              ...
              <app-main-header>
                  <app-main-nav>
                      ...
                      <app-main-nav-item text="Jeux" [isCurrent]="true" link="#" />
              ...
              <div class="px-6">
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Jeux recommandés</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Streams recommandés</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Action et aventure</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Jeux de rôle</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Jeux de tir</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">MOBA et stratégie</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Horreur</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Courses de voiture et sports</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Combat</h3>
...
export const Gaming = exampleTemplate.bind({});
Gaming.args = { title: 'Angular Twitch Clone' };

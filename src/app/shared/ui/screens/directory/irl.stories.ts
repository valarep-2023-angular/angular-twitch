...
export default {
  ...
  args: {
    games: [
      ...
      {
        title: 'Voyages et nature',
        subTitle: '455 spectateurs',
        image: 'https://static-cdn.jtvnw.net/ttv-boxart/509672-188x250.jpg',
        tags: ['IRL']
      },
      {
        title: 'ASMR',
        subTitle: '455 spectateurs',
        image: 'https://static-cdn.jtvnw.net/ttv-boxart/509659-188x250.jpg',
        tags: ['IRL']
      },
      {
        title: 'Sciences et technologie',
        subTitle: '455 spectateurs',
        image: 'https://static-cdn.jtvnw.net/ttv-boxart/509670-188x250.jpg',
        tags: ['IRL']
      }
    ],
    streams: [
          ...
          <div class="bg-gray-900">
              ...
              <app-main-header>
                  <app-main-nav>
                      ...
                      <app-main-nav-item text="IRL" [isCurrent]="true" link="#" />
              ...
              <div class="px-6">
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Catégories IRL recommandées</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Streams IRL recommandés</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Sport</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">ASMR</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Voyage et extérieur</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Talk-shows et podcasts</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Piscines, jacuzzi et plages</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Événements spéciaux</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Politique</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Science et technologie</h3>
                  ...
                  <h3 class="text-white text-xl font-medium py-4">Discussions</h3>
...
export const IRL = exampleTemplate.bind({});
IRL.args = { title: 'Angular Twitch Clone' };
